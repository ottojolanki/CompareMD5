...
def get_args():
    ...
    parser.add_argument(
        'dirs', help='Two directories containing files to compare', nargs=2)
...
def main():
    ...
    dir_1_basenames = {
        ...
        for fname in os.listdir(dir_1_abspath)
        if os.path.isfile(os.path.join(dir_1_abspath, fname))
    }
    dir_2_basenames = {
        os.path.basename(fname)
        for fname in os.listdir(dir_2_abspath)
    ...
    common_names_in_dir1 = [
        os.path.join(dir_1_abspath, name) for name in common_basenames
    ]
    common_names_in_dir2 = [
        os.path.join(dir_2_abspath, name) for name in common_basenames
    ]
